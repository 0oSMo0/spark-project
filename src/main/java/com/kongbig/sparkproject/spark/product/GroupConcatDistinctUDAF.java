...
/**
 * Describe: 组内拼接去重函数(group_concat_distinct())
 * 技术点4：自定义UDAF聚合函数
 * Author:   kongbig
 * Data:     2018/3/29 15:17.
 */
public class GroupConcatDistinctUDAF extends UserDefinedAggregateFunction {
    private static final long serialVersionUID = 6895061619547602896L;
